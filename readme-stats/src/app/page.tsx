...
const techGroups = [
  {
    title: "Frontend",
    keys: "react,nextjs,angular,typescript,javascript,html5,css3,tailwindcss,mui,chakra,radix_ui,redux,redux_saga,zustand,react_hook_form,rtk_query,react_query,react_select,react_datepicker,apexcharts".split(",")
  },
  {
    title: "UI Tools",
    keys: "vitest,axios,lodash,nextjs,next_auth,zod,yup,dayjs,date_fns,i18next,jspdf,react_quill,react_toastify,stylis_plugin_rtl,react_dropzone,monaco_editor,react_easy_crop,google_libphonenumber,dnd_kit,emotion_react".split(",")
  },
  {
    title: "Backend",
  ...
  {
    title: "Databases",
    keys: "postgresql,mongodb,sqlite,dynamodb,supabase,prisma,typeorm,drizzle_orm,db".split(",")
  },
  {
    title: "Tools & Development",
    keys: "git,github,gitlab,vscode,cursor,windsurf,kiro,claude_code,claude_desktop,codex,devin,gemini,gemini_cli,claude,chatgpt,ai_studio,antigravity,antigravity_cli,pnpm,npm,sonarqube,postman,linux,windows,wsl,eslint,prettier,lefthook,husky".split(",")
  },
  {
    title: "Languages & Scripting",
    keys: "javascript,typescript,python,html5,css3,sql,json,yaml,xml,terraform,bash,zsh,powershell".split(",")
  }
];
